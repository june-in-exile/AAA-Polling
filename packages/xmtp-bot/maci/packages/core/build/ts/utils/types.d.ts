...
import type { Ballot, IJsonBallot, IJsonPCommand, IJsonStateLeaf, Keypair, Message, PCommand, PubKey, StateLeaf } from "maci-domainobjs";
/**
...
export interface IMaciState {
    ...
    deployPoll(pollEndTimestamp: bigint, treeDepths: TreeDepths, messageBatchSize: number, coordinatorKeypair: Keypair): bigint;
    deployNullPoll(): void;
    copy(): MaciState;

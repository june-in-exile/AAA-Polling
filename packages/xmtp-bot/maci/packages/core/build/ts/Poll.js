...
class Poll {
     ...
     */
    constructor(pollEndTimestamp, coordinatorKeypair, treeDepths, batchSizes, maciStateRef) {
        this.ballots = [];
        this.messages = [];
        this.commands = [];
        this.encPubKeys = [];
        ...
        this.updatePoll = (numSignups) => {
            ...
            this.stateTree = new maci_crypto_1.IncrementalQuinTree(this.actualStateTreeDepth, maci_domainobjs_1.blankStateLeafHash, constants_1.STATE_TREE_ARITY, maci_crypto_1.hash2);
            // add all leaves
            ...
            this.ballotTree = new maci_crypto_1.IncrementalQuinTree(this.stateTreeDepth, this.emptyBallotHash, constants_1.STATE_TREE_ARITY, maci_crypto_1.hash2);
        ...
        this.processMessage = (message, encPubKey, qv = true) => {
            try {
                ...
                console.log("old pubKey =", stateLeaf.pubKey.serialize());
                newStateLeaf.pubKey = command.newPubKey.copy();
                console.log("new pubKey =", newStateLeaf.pubKey.serialize());
                ...
                const vt = new maci_crypto_1.IncrementalQuinTree(this.treeDepths.voteOptionTreeDepth, 0n, constants_1.MESSAGE_TREE_ARITY, maci_crypto_1.hash5);
        ...
        this.tallyVotes = () => {
            ...
            const emptyBallot = new maci_domainobjs_1.Ballot(this.maxVoteOptions, this.treeDepths.voteOptionTreeDepth);
        ...
        this.maxVoteOptions = constants_1.MESSAGE_TREE_ARITY ** this.treeDepths.voteOptionTreeDepth;
        this.maxMessages = constants_1.MESSAGE_TREE_ARITY ** this.treeDepths.messageTreeDepth;
        ...
        this.emptyBallot = maci_domainobjs_1.Ballot.genBlankBallot(this.maxVoteOptions, treeDepths.voteOptionTreeDepth);
        this.ballots.push(this.emptyBallot);
    }
    /**
    ...
    static fromJSON(json, maciState) {
        const poll = new Poll(BigInt(json.pollEndTimestamp), new maci_domainobjs_1.Keypair(), json.treeDepths, json.batchSizes, maciState);
        // set all properties
        ...
        poll.commands = json.commands.map((command) => maci_domainobjs_1.PCommand.fromJSON(command));

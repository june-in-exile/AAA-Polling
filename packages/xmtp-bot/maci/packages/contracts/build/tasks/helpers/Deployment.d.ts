...
import { EContracts, IDeployContractParams, IDeployContractWithLinkedLibrariesParams, IDeployParams, IDeployStep, IGetContractParams } from "./types";
/**
...
export declare class Deployment {
     ...
     */
    deployContract<T extends BaseContract, ID = EContracts>({ name, abi, bytecode, signer }: IDeployContractParams<ID>, ...args: unknown[]): Promise<T>;
    /**
     ...
     * @returns deployed contract
     */
    deployContractWithLinkedLibraries<T extends BaseContract>({ contractFactory, signer }: IDeployContractWithLinkedLibrariesParams, ...args: unknown[]): Promise<T>;
    /**
     ...
     */
    getDeployConfigField<T = string | number | boolean, ID extends string = EContracts>(id: ID, field: string, mustGet?: boolean): T;
    /**
     ...
     */
    updateDeployConfig<T = string | number | boolean, ID extends string = EContracts>(id: ID, field: string, value: T): void;
    /**
     ...
     */
    getContract<T extends BaseContract>({ name, key, address, abi, signer }: IGetContractParams): Promise<T>;
}

...
class TreeMerger {
     ...
     */
    constructor({ deployer, messageAccQueueContract, pollContract }) {
     ...
     */
    async mergeMessageSubtrees(queueOps) {
...
exports.TreeMerger = TreeMerger;
//# sourceMappingURL=TreeMerger.js.map
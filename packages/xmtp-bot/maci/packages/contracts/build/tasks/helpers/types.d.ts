...
import type { BaseContract, BigNumberish, Fragment, JsonFragment, Signer, ContractFactory, Interface, InterfaceAbi } from "ethers";
 ...
 */
export declare enum EGatekeepers {
 ...
 */
export declare enum EInitialVoiceCreditProxies {
    Constant = "ConstantInitialVoiceCreditProxy"
}
/**
 * Enum represents deployed contracts
 */
export declare enum EContracts {

...
export interface HatsGatekeeperMultipleInterface extends Interface {
    getFunction(nameOrSignature: "criterionHat" | "getTrait" | "hats" | "maci" | "owner" | "register" | "registered" | "renounceOwnership" | "setMaciInstance" | "transferOwnership"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "OwnershipTransferred"): EventFragment;
    encodeFunctionData(functionFragment: "criterionHat", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "criterionHat", data: BytesLike): Result;
...
export interface HatsGatekeeperMultiple extends BaseContract {
    connect(runner?: ContractRunner | null): HatsGatekeeperMultiple;
    waitForDeployment(): Promise<this>;
    interface: HatsGatekeeperMultipleInterface;
    ...
    criterionHat: TypedContractMethod<[arg0: BigNumberish], [boolean], "view">;
    ...
    getFunction(nameOrSignature: "criterionHat"): TypedContractMethod<[arg0: BigNumberish], [boolean], "view">;
    getFunction(nameOrSignature: "getTrait"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "hats"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "registered"): TypedContractMethod<[arg0: AddressLike], [boolean], "view">;
...
//# sourceMappingURL=HatsGatekeeperMultiple.d.ts.map
...
export interface EASGatekeeperInterface extends Interface {
    getFunction(nameOrSignature: "attester" | "eas" | "getTrait" | "maci" | "owner" | "register" | "registeredAttestations" | "renounceOwnership" | "schema" | "setMaciInstance" | "transferOwnership"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "registeredAttestations", values: [BytesLike]): string;
    ...
    decodeFunctionResult(functionFragment: "registeredAttestations", data: BytesLike): Result;
...
export interface EASGatekeeper extends BaseContract {
    ...
    getFunction(nameOrSignature: "eas"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "registeredAttestations"): TypedContractMethod<[arg0: BytesLike], [boolean], "view">;
...
//# sourceMappingURL=EASGatekeeper.d.ts.map
...
export interface SignUpTokenInterface extends Interface {
    getFunction(nameOrSignature: "approve" | "balanceOf" | "getApproved" | "giveToken" | "isApprovedForAll" | "name" | "owner" | "ownerOf" | "renounceOwnership" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "symbol" | "tokenURI" | "transferFrom" | "transferOwnership"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "giveToken", values: [AddressLike, BigNumberish]): string;
...
export interface SignUpToken extends BaseContract {
    connect(runner?: ContractRunner | null): SignUpToken;
    ...
    giveToken: TypedContractMethod<[
        to: AddressLike,
        curTokenId: BigNumberish
    ], [
        void
    ], "nonpayable">;
    ...
    getFunction(nameOrSignature: "giveToken"): TypedContractMethod<[
        to: AddressLike,
        curTokenId: BigNumberish
    ], [
        void
...
//# sourceMappingURL=SignUpToken.d.ts.map
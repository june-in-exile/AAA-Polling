...
export declare namespace Pairing {
    ...
    type G1PointStructOutput = [x: bigint, y: bigint] & {
        x: bigint;
        y: bigint;
    };
    type G2PointStruct = {
...
export interface VerifierInterface extends Interface {
    ...
    encodeFunctionData(functionFragment: "verify", values: [BigNumberish[], SnarkCommon.VerifyingKeyStruct, BigNumberish[]]): string;
...
export interface Verifier extends BaseContract {
    ...
    getFunction(nameOrSignature: "PRIME_Q"): TypedContractMethod<[], [bigint], "view">;

...
export interface MerkleProofGatekeeperInterface extends Interface {
    getFunction(nameOrSignature: "getTrait" | "maci" | "owner" | "register" | "registeredAddresses" | "renounceOwnership" | "root" | "setMaciInstance" | "transferOwnership"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "registeredAddresses", values: [AddressLike]): string;
    ...
    decodeFunctionResult(functionFragment: "registeredAddresses", data: BytesLike): Result;
...
export interface MerkleProofGatekeeper extends BaseContract {
    connect(runner?: ContractRunner | null): MerkleProofGatekeeper;
    waitForDeployment(): Promise<this>;
    interface: MerkleProofGatekeeperInterface;
    ...
    getFunction(nameOrSignature: "registeredAddresses"): TypedContractMethod<[arg0: AddressLike], [boolean], "view">;
...
//# sourceMappingURL=MerkleProofGatekeeper.d.ts.map
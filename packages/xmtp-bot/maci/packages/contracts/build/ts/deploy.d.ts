...
import { ConstantInitialVoiceCreditProxy, FreeForAllGatekeeper, MockVerifier, PollFactory, SignUpToken, SignUpTokenGatekeeper, Verifier, VkRegistry, PollFactory__factory as PollFactoryFactory, GitcoinPassportGatekeeper, SemaphoreGatekeeper } from "../typechain-types";
/**
 ...
 */
export declare const createContractFactory: (abi: TAbi, bytecode: string, signer?: Signer) => Promise<ContractFactory>;
/**
 ...
 */
export declare const deployGitcoinPassportGatekeeper: (decoderAddress: string, minimumScore: number, signer?: Signer, quiet?: boolean) => Promise<GitcoinPassportGatekeeper>;
/**
 ...
 */
export declare const deploySemaphoreGatekeeper: (semaphoreAddress: string, groupId: bigint, signer?: Signer, quiet?: boolean) => Promise<SemaphoreGatekeeper>;
/**
 ...
 */
export declare const deployContractWithLinkedLibraries: <T extends BaseContract>(contractFactory: ContractFactory, ...args: unknown[]) => Promise<T>;
/**
 ...
 */
export declare const deployPollFactory: (signer: Signer, factory: typeof PollFactoryFactory | undefined, quiet?: boolean) => Promise<PollFactory>;
/**
 * Deploy a MACI contract
 * @param {IDeployMaciArgs} args - deploy arguments
 * @returns {IDeployedMaci} the deployed MACI contract
 */
export declare const deployMaci: ({ signUpTokenGatekeeperContractAddress, initialVoiceCreditBalanceAddress, signer, poseidonAddresses, stateTreeDepth, factories, quiet, }: IDeployMaciArgs) => Promise<IDeployedMaci>;

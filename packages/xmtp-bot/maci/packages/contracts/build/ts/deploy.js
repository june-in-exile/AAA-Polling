...
exports.deployMaci = exports.deployPollFactory = exports.deployContractWithLinkedLibraries = exports.deployPoseidonContracts = exports.deploySemaphoreGatekeeper = exports.deployGitcoinPassportGatekeeper = exports.deployFreeForAllSignUpGatekeeper = exports.deploySignupTokenGatekeeper = exports.deploySignupToken = exports.deployConstantInitialVoiceCreditProxy = exports.deployVerifier = exports.deployMockVerifier = exports.deployVkRegistry = exports.deployContract = exports.createContractFactory = void 0;
const Deployment_1 = require("../tasks/helpers/Deployment");
const typechain_types_1 = require("../typechain-types");
const genEmptyBallotRoots_1 = require("./genEmptyBallotRoots");
 ...
 */
const deployGitcoinPassportGatekeeper = async (decoderAddress, minimumScore, signer, quiet = false) => (0, exports.deployContract)("GitcoinPassportGatekeeper", signer, quiet, decoderAddress, minimumScore.toString());
exports.deployGitcoinPassportGatekeeper = deployGitcoinPassportGatekeeper;
/**
 ...
 */
const deploySemaphoreGatekeeper = async (semaphoreAddress, groupId, signer, quiet = false) => (0, exports.deployContract)("SemaphoreGatekeeper", signer, quiet, semaphoreAddress, groupId.toString());
exports.deploySemaphoreGatekeeper = deploySemaphoreGatekeeper;
/**
 ...
 */
const deployPollFactory = async (signer, factory, quiet = false) => {
    ...
    const pollFactory = factory || typechain_types_1.PollFactory__factory;
    const contractFactory = await (0, exports.createContractFactory)(pollFactory.abi, pollFactory.linkBytecode({
 ...
 */
const deployMaci = async ({ signUpTokenGatekeeperContractAddress, initialVoiceCreditBalanceAddress, signer, poseidonAddresses, stateTreeDepth = 10, factories, quiet = true, }) => {
    ...
    const linkedContractFactories = factories ||
        (await Promise.all(contractsToLink.map(async (factory) => (0, exports.createContractFactory)(factory.abi, factory.linkBytecode({
    ...
    const [maciContractFactory, pollFactoryContractFactory, messageProcessorFactory, tallyFactory] = linkedContractFactories;
    ...
    const maciContract = await (0, exports.deployContractWithLinkedLibraries)(maciContractFactory, pollAddress, messageProcessorAddress, tallyAddress, signUpTokenGatekeeperContractAddress, initialVoiceCreditBalanceAddress, stateTreeDepth, emptyBallotRoots);
    return {
        maciContract,
        pollFactoryContract,
        poseidonAddrs,

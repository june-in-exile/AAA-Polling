...
export declare namespace Params {
  ...
  export type ExtContractsStructOutput = [maci: string, messageAq: string] & {
    maci: string;
    messageAq: string;
  };
}
...
export interface PollInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "mergeMaciState",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export namespace MergeMaciStateEvent {
...
export interface Poll extends BaseContract {
  ...
  extContracts: TypedContractMethod<
    [],
    [[string, string] & { maci: string; messageAq: string }],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "maxMessages"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "mergeMaciState"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
  ...
  getEvent(
    ...
    MergeMaciStateEvent.InputTuple,
    MergeMaciStateEvent.OutputTuple,
    MergeMaciStateEvent.OutputObject
  >;
  getEvent(
    key: "MergeMessageAq"
  ): TypedContractEvent<
  ...
  filters: {
    "MergeMaciState(uint256,uint256)": TypedContractEvent<
      MergeMaciStateEvent.InputTuple,
      MergeMaciStateEvent.OutputTuple,
      MergeMaciStateEvent.OutputObject
    >;
    MergeMaciState: TypedContractEvent<
      MergeMaciStateEvent.InputTuple,
      MergeMaciStateEvent.OutputTuple,
      MergeMaciStateEvent.OutputObject
    >;
